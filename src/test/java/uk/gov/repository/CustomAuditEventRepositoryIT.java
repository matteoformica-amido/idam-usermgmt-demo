...
import uk.gov.config.audit.AuditEventConverter;
import uk.gov.domain.PersistentAuditEvent;
...
import static uk.gov.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
